...
print("-" * 60)
display_lags = [v for v in lag_vars if v in ['ln_y_lag1', 'ln_y_lag7', 'ln_y_lag30']]
display_vars = display_lags + [v for v in lag_vars if v not in display_lags] + market_main_vars
